        ...
        try {
            ...
            userId =
                users.length > 0
                    ...
                    : 1; // Enkelt sätt att generera unikt ID
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-md mx-auto p-6">
            ...
            <div className="flex items-start text-sm mb-2">
                ...
                />
                <p>
                    Anmäl mig till nyhetsbrevet för att få exklusiva erbjudanden
                    och uppdateringar. (Valfritt)
                </p>
            </div>
            ...
            <button
                type="submit"
                disabled={
                    !termsAccepted || !isPasswordValid() || !matchPasswords
                }
