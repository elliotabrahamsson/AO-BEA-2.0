  ...
  return (
    <div>
        ...
        <section className='mt-6'>
            ...
            <div
                className="flex justify-between ml-4 mr-4 mt-8 border-t-2 border-b-2 pt-4 pb-4 text-2xl">
                <p>Totalsumma:</p>
                <p>{/* Totalsumma */}</p>
            </div>
        </section>
        ...
        <div
        className="bg-[var(--dark3)] p-4 relative min-w-[190px] m-[1em] mt-20 mb-10 h-[44px] flex justify-center items-center rounded-[4px]"
      >
